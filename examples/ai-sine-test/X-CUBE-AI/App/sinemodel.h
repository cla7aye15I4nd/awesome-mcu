...
#ifndef AI_SINEMODEL_H
#define AI_SINEMODEL_H
#pragma once
...
/******************************************************************************/
#define AI_SINEMODEL_MODEL_NAME          "sinemodel"
#define AI_SINEMODEL_ORIGIN_MODEL_NAME   "model_no_quant"

/******************************************************************************/
#define AI_SINEMODEL_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_SINEMODEL_IN_NUM        (1)
#define AI_SINEMODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINEMODEL_IN_SIZE { \
  AI_SINEMODEL_IN_1_SIZE, \
}
#define AI_SINEMODEL_IN_SIZE_BYTES { \
  AI_SINEMODEL_IN_1_SIZE_BYTES, \
}
#define AI_SINEMODEL_IN_1_CHANNEL     (1)
#define AI_SINEMODEL_IN_1_SIZE        (1)
#define AI_SINEMODEL_IN_1_SIZE_BYTES  (AI_SINEMODEL_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_SINEMODEL_OUT_NUM       (1)
#define AI_SINEMODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINEMODEL_OUT_SIZE { \
  AI_SINEMODEL_OUT_1_SIZE, \
}
#define AI_SINEMODEL_OUT_SIZE_BYTES { \
  AI_SINEMODEL_OUT_1_SIZE_BYTES, \
}
#define AI_SINEMODEL_OUT_1_CHANNEL     (1)
#define AI_SINEMODEL_OUT_1_SIZE        (1)
#define AI_SINEMODEL_OUT_1_SIZE_BYTES  (AI_SINEMODEL_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_SINEMODEL_N_NODES (5)
 ...
 * @ref ai_sinemodel_create. Both the activations memory buffer 
 ...
 * using @ref ai_sinemodel_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_SINEMODEL_*
 * defines into file @ref sinemodel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_sinemodel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SINEMODEL_H */
