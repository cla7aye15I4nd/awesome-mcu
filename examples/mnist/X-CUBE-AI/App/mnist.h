...
#define AI_MNIST_ORIGIN_MODEL_NAME   "mnist_optimized_for_size"
...
#define AI_MNIST_IN_1_SIZE        (28 *  28 *  1)
#define AI_MNIST_IN_1_SIZE_BYTES  (AI_MNIST_IN_1_SIZE * 4)
...
#define AI_MNIST_OUT_1_SIZE_BYTES  (AI_MNIST_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_MNIST_N_NODES (3)
