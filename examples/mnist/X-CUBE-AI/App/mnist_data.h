...
#define AI_MNIST_DATA_ACTIVATIONS_SIZE     (10608)

#define AI_MNIST_DATA_ACTIVATIONS_COUNT    (1)

#define AI_MNIST_DATA_WEIGHTS_SIZE         (81640)
...
#define AI_MNIST_DATA_ACTIVATIONS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8, \
    AI_MNIST_DATA_ACTIVATIONS_COUNT, 1, AI_MNIST_DATA_ACTIVATIONS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )

#define AI_MNIST_DATA_WEIGHTS(ptr_)  \
  AI_BUFFER_OBJ_INIT( \
    AI_BUFFER_FORMAT_U8|AI_BUFFER_FMT_FLAG_CONST, \
    AI_MNIST_DATA_WEIGHTS_COUNT, 1, AI_MNIST_DATA_WEIGHTS_SIZE, 1, \
    AI_HANDLE_PTR(ptr_) )
