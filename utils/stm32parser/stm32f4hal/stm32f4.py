...
class STM32F4xxCrc:
    class Type(ctypes.Structure):
        ...
        _fields_ = [
            ...
            ("RESERVED1", ctypes.c_uint16), #Reserved, 0x06
...
class STM32F4xxRcc:
    class Type(ctypes.Structure):
        ...
        _fields_ = [
            ...
            ("RESERVED7" , ctypes.c_uint32 * 1), #Reserved, 0x88
...
class STM32F4xxCan:
    class Type(ctypes.Structure):
        ...
        _fields_ = [
            ...
            ("sTxMailBox"     , CAN_TxMailBox * 3),       #CAN Tx MailBox,                      Address offset: 0x180 - 0x1AC
            ("sFIFOMailBox"   , CAN_FIFOMailBox * 2),     #CAN FIFO MailBox,                    Address offset: 0x1B0 - 0x1CC
            ...
            ("sFilterRegister", CAN_FilterRegister * 28), #CAN Filter Register,                 Address offset: 0x240-0x31C
        ]
...
class STM32F4xxSpdifrx:
    class Type(ctypes.Structure):
        ...
        _fields_ = [
            ...
            ("IMR"      , ctypes.c_uint16), #Interrupt mask register,            Address offset: 0x04
            ("RESERVED0", ctypes.c_uint16), #Reserved,  0x06
            ("SR"       , ctypes.c_uint32), #Status register,                    Address offset: 0x08
            ("IFCR"     , ctypes.c_uint16), #Interrupt Flag Clear register,      Address offset: 0x0C
            ("RESERVED1", ctypes.c_uint16), #Reserved,  0x0E
            ...
            ("RESERVED2", ctypes.c_uint16), #Reserved,  0x1A
        ]
